var allSubstances = [
    ...
    {title: 'Smoking (Cigarettes)', description: 'Smoking is the leading cause of preventable death in the world. Read about the effects of cigarettes in your body.', image: 'https://images.pexels.com/photos/1058472/pexels-photo-1058472.jpeg?auto=compress&cs=tinysrgb&dpr=3&h=750&w=1260', link: '/substances/404.html'},
    
    {title: 'Smoking (E-Cigarettes)', description: 'Also known as vaping, smoking E-cigarettes have become another popular substance that adolescents use. The term \'vaping\' can include vaping nicotine, marijuana, or flavoring.', image: 'https://images.pexels.com/photos/4834389/pexels-photo-4834389.jpeg?auto=compress&cs=tinysrgb&dpr=2&h=650&w=940', link: '/substances/404.html'},
    
    {title: 'Internet Addiction (IA)', description: 'IA, also called pathological Internet use, compulsive computer use, or Internet dependence, is a phenomenon in which Internet usage starts to affect important aspects of life. Although not included in the DSM-5, this is an interesting area of study.', image: 'https://images.pexels.com/photos/67112/pexels-photo-67112.jpeg?auto=compress&cs=tinysrgb&dpr=2&w=500', link: '/substances/404.html'}];
